...
A client-side retirement projection calculator. Model Traditional/Roth/taxable/ESOP
accounts, salary growth, Social Security claim-age optimization, and legacy/trust
planning — all in the browser, with a downloadable PDF report.
...
- Recommends a Social Security claim age by comparing lifetime resource objectives
  across ages 62–70.
- Models employer match, ESOP dilution/growth, and a trust/legacy spend-down phase.
